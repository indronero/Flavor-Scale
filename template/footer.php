      ...
      <div class="container">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Flavor Scale</a></li>
                <li><a href="#" class="py-2 d-block">Flavor Scale</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p>
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="icon-heart"aria-hidden="true"></i> by <a href="https://projectworlds.in" target="_blank">Flavor Scale</a>
            </p>
          </div>
        </div>
      </div>
